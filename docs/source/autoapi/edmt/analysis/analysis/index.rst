...
.. py:function:: _ndvi_from_nir_red(img: ee.Image, nir: str, red: str) -> ee.Image
...
.. py:function:: compute_per_period(date: ee.Date, frequency: str, collection: ee.ImageCollection, satellite: str, roi: Optional[ee.Geometry] = None, name: str = 'composite') -> ee.Image
