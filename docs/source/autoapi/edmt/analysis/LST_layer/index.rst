...
.. py:function:: get_lst_period_collection(start_date: str, end_date: str, satellite: str = 'MODIS', frequency: Literal['weekly', 'monthly', 'yearly'] = 'monthly', roi_gdf: Optional[geopandas.GeoDataFrame] = None) -> ee.ImageCollection
