...
.. py:function:: get_ndvi_period_collection(start_date: str, end_date: str, satellite: str = 'MODIS', frequency: Literal['weekly', 'monthly', 'yearly'] = 'monthly', roi_gdf: Optional[geopandas.GeoDataFrame] = None, period_reducer: Literal['mean', 'median', 'min', 'max'] = 'mean') -> ee.ImageCollection
